...
<body class="container">
    ...
    <form action="validacion.php" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" name="isbn" class="form-control" id="isbn" placeholder="1234-1234-1234-1234-1">
        </div>
        <br>
        <button type="submit" name="enviar" class="btn btn-primary">Añadir Registro</button>
      </form>
</body>
</html>